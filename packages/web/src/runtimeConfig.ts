import { getRuntimeExtraHeadersSync, refreshLocalRuntimeUrlAuthToken, refreshRuntimeUrlAuthToken, setRuntimeBearerToken, setRuntimeExtraHeaders } from '@ocelot/ui/lib/runtime-auth';
import { installRuntimeFetchBridge } from '@ocelot/ui/lib/runtime-fetch';
import { initializeRuntimeEndpoint } from '@ocelot/ui/lib/runtime-switch';
import { configureRuntimeUrlResolver } from '@ocelot/ui/lib/runtime-url';
