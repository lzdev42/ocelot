...
Keep the review concise and practical. Respond in the same language the user uses.`,
  ...
  },
  {
    ...
    template: `Produce a review handoff for another agent. Do not compact or mutate session history. Your output is an assistant message that Ocelot will send to a separate reviewer agent.
...
- Do not mention Ocelot metadata, linked sessions, session IDs, or routing
- Respond in the same language the user used most in the conversation`,
  },
  {
...
{{implementation_response}}`,
  },
  {
    ...
    template: 'I want to start planning a feature.{{user_description_line}}',
  },
  {
...
Respond in the same language the user uses.`,
  },
  {
    ...
    template: 'I want to debug an issue.{{user_description_line}}',
  },
  {
...
Respond in the same language the user uses.`,
  },
  {
    ...
    template: 'Help me decide how to approach this.{{user_description_line}}',
  },
  {
...
Respond in the same language the user uses.`,
  },
  {
    ...
    template: 'Give me a high-level tour of this codebase.{{focus_area_line}}',
  },
  {
