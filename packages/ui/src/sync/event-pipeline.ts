...
const normalizeOcelotSessionStatus = (payload: Event): Event | null => {
...
const normalizeEventType = (payload: Event): Event => {
  const normalizedOcelotStatus = normalizeOcelotSessionStatus(payload)
  if (normalizedOcelotStatus) {
    return normalizedOcelotStatus
  }
