  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running Ocelot. Verify the address points to an Ocelot server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The Ocelot server at "${host || 'unknown'}" is not compatible with this app version. Update Ocelot on the server, then try again.`,
