...
import { OcelotVisualSettings } from './OcelotVisualSettings';
...
import type { OcelotSection } from './types';
...
interface OcelotPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: OcelotSection;
}

export const OcelotPage: React.FC<OcelotPageProps> = ({ section }) => {
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <OcelotVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',
