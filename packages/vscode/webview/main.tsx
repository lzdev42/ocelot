...
import { opencodeClient } from '@ocelot/ui/lib/opencode/client';
import { sanitizeHeadersForBrowser } from '@ocelot/ui/lib/runtime-fetch';
import {
  buildVSCodeThemeFromPalette,
  readVSCodeThemePalette,
  type VSCodeThemeKind,
  type VSCodeThemePayload,
} from '@ocelot/ui/lib/theme/vscode/adapter';
import { getBootstrapMessages, readStoredLocaleForBootstrap } from '@ocelot/ui/lib/i18n';
...
onCommand('reloadOpenCode', () => {
  void import('@ocelot/ui/stores/useAgentsStore').then(({ reloadOpenCodeConfiguration }) => {
...
onCommand('settingsSynced', () => {
  import('@ocelot/ui/lib/persistence').then(({ syncDesktopSettings }) => {
...
import('@ocelot/ui/apps/renderVSCodeApp')
